...
public class NodeLabelRenderer implements WaypointRenderer<NodeLabel> {

private static final Log log = LogFactory.getLog(NodeLabelRenderer.class);
...
//	private final Font font = new Font("Lucida Sans", Font.BOLD, 10);
	...
	@Override
	public void paintWaypoint(Graphics2D g, JXMapViewer viewer, NodeLabel w)
	{
